...
export const NUMBER_SCROLLER_PRESETS = {
  ...
  weight: { min: 25, max: 200, step: 1, unit: 'kg' },
  chest: { min: 40, max: 150, step: 1, unit: 'cm' },
  thigh: { min: 25, max: 90, step: 1, unit: 'cm' },
  navel: { min: 40, max: 140, step: 1, unit: 'cm' },
  bicep: { min: 14, max: 60, step: 1, unit: 'cm' },
