    ...
    case 'initial_diet':
      return appendNote(
        [
          ...
          'Use the Training Mesocycle calorie wave: start the opening cycle at base calories, then raise intake modestly as weekly workload rises.',
          'Use previous unsuccessful diet attempts as context and do not repeat an approach the client found ineffective or unsustainable.',
          'If the client reports genuinely low intake without fat loss, audit adherence and intake details before changing calories; when low intake is credible, do not cut again and raise the average daily target gradually by 50 to 100 kcal before reassessing.',
          'For weight gain, never force an oversized surplus or uncomfortable food volume; begin at the lower end and let appetite, digestion, and training tolerance adapt before increasing.',
          'Never claim that metabolism is broken, damaged, fixed, or repaired.',
          'Do not use any hyphen or dash character in client facing plan text. Rewrite ranges with the word to and compound words with spaces.',
    ...
    case 'review_update_diet':
      return appendNote(
        [
          ...
          'Obey the Training Mesocycle calorie wave: raise average calories modestly as workload rises through the cycle, then reduce them by about 100 to 200 kcal when a new split begins at base volume.',
          'Keep the calorie wave inside the goal appropriate Metabolic Flux band and let check in safety signals override an increase.',
          'For a fat loss or recomp stall on genuinely low intake, first audit adherence, weekends, cooking fats, drinks, steps, sleep, and water changes; if adherence is high, do not cut again and reverse toward a sustainable intake by adding 50 to 100 kcal to the average daily target, then hold and reassess.',
          'For weight gain, never force an oversized surplus or uncomfortable food volume; hold or reduce the target when appetite or digestion is poor and increase only after reviewing at least two weeks of trend and recovery.',
          'Never claim that metabolism is broken, damaged, fixed, or repaired.',
          'Do not use any hyphen or dash character in client facing plan text. Rewrite ranges with the word to and compound words with spaces.',
          'Always specify exact ghee/oil/butter amounts for cooked meals and a daily cooking-fat total.',
          'Obey the client meal-variety preference (same daily / 50-50 / different daily).',
