...
export const SAFE_RATE_OF_CHANGE_RULE = [
  ...
  '- Fat LOSS / cutting: if the client asks to "lose fast", "crash", or "cut calories hard", do NOT slash calories. Use the flux deficit already computed in CALORIE METHOD: 250 kcal below maintenance on steady, 200 on build-up, and 150 on high flux. Explain that steps and training make up the rest of the gap.',
