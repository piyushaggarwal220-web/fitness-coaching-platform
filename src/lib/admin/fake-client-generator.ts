...
export function generateFakeOnboardingForm(name?: string): OnboardingFormData {
  ...
  return {
    ...
    timing_breakfast: pick(['7:30 am', '8:00 am', '8:30 am']),
    timing_lunch: pick(['1:00 pm', '1:30 pm', '2:00 pm']),
    timing_dinner: pick(['8:00 pm', '8:30 pm', '9:00 pm']),
    timing_snacks: pick(['4:30 pm', '6:00 pm', '6:30 pm']),
