...
export function generateFakeOnboardingForm(name?: string): OnboardingFormData {
  ...
  return {
    ...
    training_tenure: pick(TRAINING_TENURE_OPTIONS).value,
    ...
    diet_custom_notes: '',
    previous_diet_attempts: pick([
      'None',
      'A very restrictive diet that caused low energy and was difficult to maintain.',
      'Skipped meals for two months but did not see lasting progress.',
    ]),
