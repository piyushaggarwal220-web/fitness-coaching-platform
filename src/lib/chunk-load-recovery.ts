...
export const CHUNK_LOAD_USER_MESSAGE =
  'The app was updated. Please refresh this page and continue — your answers are already saved.'
...
/** Retry a dynamic import once when the first attempt hits a stale/missing chunk. */
