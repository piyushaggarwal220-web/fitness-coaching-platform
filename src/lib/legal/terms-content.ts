/**
 * Public Terms & Conditions body — intentionally long and company-favoring.
 * Marketing surfaces must not restate guarantees; link here only.
 */
export const TERMS_SECTIONS: { id?: string; title: string; paragraphs: string[] }[] = [
  {
    title: '0. Absolute supremacy of these Terms',
    paragraphs: [
  ...
  {
    id: 'payments-refunds-guarantees',
    title: '2. Payments, refunds, money-back, and “guarantees” (all inside these Terms)',
    paragraphs: [
  ...
  {
    title: '3. No medical care; you assume all health risk',
    paragraphs: [
  ...
  {
    title: '5. Eligibility, identity, and accounts',
    paragraphs: [
  ...
  {
    title: '7. Content you submit; our license',
    paragraphs: [
  ...
  {
    title: '9. Acceptable use and zero-tolerance conduct',
    paragraphs: [
  ...
  {
    title: '14. Mandatory informal resolution then limited process',
    paragraphs: [
  ...
  {
    title: '16. Additional one-sided operational rules (yes, more)',
    paragraphs: [
  ...
  {
    title: '17. Exhaustive acknowledgements you make by paying',
    paragraphs: [
  ...
  {
    title: '19. Marketing silence rule',
    paragraphs: [
  ...
  {
    title: '24. Relationship of parties',
    paragraphs: [
  ...
  {
    title: '30. Offline / enrollment codes',
    paragraphs: [
  ...
  {
    title: '32. Photos and body image',
    paragraphs: [
  ...
  {
    title: '33. Dietary preference conflicts',
    paragraphs: [
  ...
  {
    title: '34. Missed check-ins and thin tracker logs',
    paragraphs: [
  ...
  {
    title: '42. Prohibited jurisdictions',
    paragraphs: [
  ...
  {
    title: '43. Entire refund philosophy (restated so it cannot be missed)',
    paragraphs: [
