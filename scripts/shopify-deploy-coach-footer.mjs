...
const files = [
  {
    filename: 'sections/lurvox-coach-footer.liquid',
    body: { type: 'TEXT', value: fs.readFileSync(path.join(src, 'sections__lurvox-coach-footer.liquid'), 'utf8') },
  },
  {
    filename: 'sections/footer-group.json',
    body: { type: 'TEXT', value: fs.readFileSync(path.join(src, 'sections__footer-group.json'), 'utf8') },
  },
