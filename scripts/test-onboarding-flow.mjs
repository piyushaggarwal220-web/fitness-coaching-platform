...
const SAMPLE_FORM = {
  ...
  can_squat: 'yes',
  can_pushup: 'yes',
  can_pullup: 'with_modification',
  recent_program: 'PPL 4 days/week',
  ...
  chicken_days: '4',
  fish_days: '1',
  egg_allowed_days: ['monday', 'thursday'],
  chicken_allowed_days: ['tuesday', 'wednesday', 'friday', 'saturday'],
...
function buildOnboardingData(form, resumeStep) {
  return {
    ...
    measurements: {
      ...
      thigh: form.thigh,
      navel: form.navel,
      leftBicep: form.left_bicep,
      rightBicep: form.right_bicep,
    },
    training: {
      ...
      canSquat: form.can_squat,
      canPushup: form.can_pushup,
      canPullup: form.can_pullup,
      recentProgram: form.recent_program,
    },
    medical: {
    ...
    diet: {
      ...
      eggAllowedDays: form.egg_allowed_days,
      chickenAllowedDays: form.chicken_allowed_days,
      fishAllowedDays: form.fish_allowed_days,
