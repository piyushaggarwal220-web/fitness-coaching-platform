...
if (!token) {
  console.error(
    'SKIP: No SUPABASE_ACCESS_TOKEN — apply supabase/migrations/20260708100000_add_home_workout_prompt_categories.sql manually in Supabase SQL editor.'
  )
  process.exit(0)
}
...
console.log('OK: home workout prompt category migration applied')
