/**
 * Deploy timer unify + mobile single-line strip + faster social proof.
 */
...
const SOCIAL = path.join(
  path.dirname(fileURLToPath(import.meta.url)),
  'tmp-new-changes-theme',
  'sections',
  'lurvox-social-proof.liquid'
)
...
const localFiles = {
  ...
  'sections/lurvox-social-proof.liquid': SOCIAL,
}
