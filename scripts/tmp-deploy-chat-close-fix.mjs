...
const value = fs.readFileSync(
  path.join(ROOT, 'scripts/shopify-assets/snippets-lurvox-marketing-chat.liquid'),
  'utf8'
)
...
const res = await fetch(GQL, {
  ...
  body: JSON.stringify({
    ...
    variables: {
      ...
      files: [{ filename: 'snippets/lurvox-marketing-chat.liquid', body: { type: 'TEXT', value } }],
    },
  }),
})
...
console.log('deployed chat close fix to', main.id, main.name)
