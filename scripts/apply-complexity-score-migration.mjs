...
if (!token) {
  console.error(
    'SKIP: No SUPABASE_ACCESS_TOKEN — apply supabase/migrations/20260708200000_complexity_score_system.sql manually.'
  )
  process.exit(0)
}
...
console.log('OK: complexity score system migration applied')
